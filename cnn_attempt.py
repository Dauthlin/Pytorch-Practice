...
class ConvolutionalNeuralNetwork(nn.Module):
    def __init__(self):
        ...
        self.conv_layer1 = nn.Conv2d(in_channels=3, out_channels=12, kernel_size=(3, 3))
        ...
        self.conv_layer2 = nn.Conv2d(in_channels=12, out_channels=24, kernel_size=(3, 3))
